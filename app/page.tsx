        ...
        <div className="bg-[url('/images/hero_Bg.svg')] bg-cover bg-center bg-no-repeat">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              <h1 className="opacity-0 animate-fade-in-up font-heading font-bold text-primary leading-tight" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
                Give with intention
              </h1>
              <p className="opacity-0 animate-fade-in-up font-body text-body/80 max-w-lg mt-4 leading-relaxed" style={{ fontSize: 'clamp(0.875rem, 2vw, 1.125rem)', animationDelay: '150ms' }}>
                Create a wishlist or fundraiser, share one link, and let the people who love you show up.
              </p>
              <div className="opacity-0 animate-fade-in-up flex items-center gap-4 mt-8 justify-center lg:justify-start" style={{ animationDelay: '300ms' }}>
              ...
              <p className="opacity-0 animate-fade-in-up font-body text-xs text-body/40 mt-6 text-center lg:text-left" style={{ animationDelay: '450ms' }}>
                Trusted by people celebrating birthdays &amp; big goals across Nigeria
              </p>
            </div>
            <div className="opacity-0 animate-scale-in flex-1 relative flex justify-center lg:justify-end lg:self-end" style={{ animationDelay: '350ms' }}>
