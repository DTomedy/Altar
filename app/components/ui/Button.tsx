...
export function Button({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex items-center justify-center font-body font-medium px-6 py-2.5 rounded-full transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 disabled:opacity-50 disabled:cursor-not-allowed',
