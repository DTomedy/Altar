          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            <Card className="text-center p-6 border-none">
              <div className="w-12 h-12 rounded-full bg-ghost flex items-center justify-center mx-auto mb-4">
                <span className="font-heading font-medium text-lg text-primary">1</span>
              </div>
              <h3 className="font-heading font-medium text-lg text-body mb-2">Create a campaign</h3>
              <p className="font-body text-sm text-body/60">Set up a birthday wishlist or a goal fundraiser in under 2 minutes.</p>
            </Card>
            <Card className="text-center p-6 border-none">
              <div className="w-12 h-12 rounded-full bg-ghost flex items-center justify-center mx-auto mb-4">
                <span className="font-heading font-medium text-lg text-primary">2</span>
              </div>
              <h3 className="font-heading font-medium text-lg text-body mb-2">Share the link</h3>
              <p className="font-body text-sm text-body/60">Send your campaign link on WhatsApp, Instagram, or anywhere your friends are.</p>
            </Card>
            <Card className="text-center p-6 border-none">
              <div className="w-12 h-12 rounded-full bg-ghost flex items-center justify-center mx-auto mb-4">
                <span className="font-heading font-medium text-lg text-primary">3</span>
              </div>
              <h3 className="font-heading font-medium text-lg text-body mb-2">Receive gifts</h3>
