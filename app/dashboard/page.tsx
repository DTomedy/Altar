...
import { Gift, Plus, TrendingUp, Activity, Layers, Users, Clock, ArrowUp, ArrowDown } from 'lucide-react';
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="font-body text-sm text-body/70 mt-1">Here&apos;s what&apos;s happening with your campaigns.</p>
        </div>
      ...
      {verified === 'true' && (
        <div className="mb-6 flex items-center gap-3 rounded-2xl bg-success/10 border border-success/20 px-5 py-4">
          ...
          <div>
            ...
            <p className="font-body text-xs text-body/70">Your account is now fully active. Welcome to Altar!</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-ghost border border-gray-200 rounded-2xl p-5">
          ...
          <p className="font-body text-xs text-body/70 flex items-center gap-1 mt-1">
