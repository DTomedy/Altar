    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-page py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="font-display font-semibold text-3xl text-body mb-2">Terms of Service</h1>
          ...
          <div className="space-y-6 font-body text-sm text-body/80 leading-relaxed">
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">2. Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">3. Eligibility</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">4. Account Registration and KYC</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">5. Campaign Rules</h2>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">6. Contributions</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">7. Platform Fees</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">8. Wallet and Withdrawals</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">9. Prohibited Activities</h2>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">10. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">11. Termination</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">12. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">13. Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="font-display font-semibold text-lg text-body mb-2">14. Contact</h2>
              <p>
