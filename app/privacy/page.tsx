    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-page py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="font-heading font-bold text-3xl text-body mb-2">Privacy Policy</h1>
          ...
          <div className="space-y-6 font-body text-sm text-body/80 leading-relaxed">
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">2. Information We Collect</h2>

              <h3 className="font-heading font-bold text-base text-body mb-1 mt-4">Account Information</h3>
              <p>
                When you register, we collect your name, email address, phone number, and a password (stored securely as a hash).
              </p>

              <h3 className="font-heading font-bold text-base text-body mb-1 mt-4">KYC Documents</h3>
              <p>
              ...
              <h3 className="font-heading font-bold text-base text-body mb-1 mt-4">Bank Information</h3>
              <p>
                To process withdrawals, we collect your Nigerian bank account number, bank code, bank name, and account name.
              </p>

              <h3 className="font-heading font-bold text-base text-body mb-1 mt-4">Campaign Content</h3>
              <p>
              ...
              <h3 className="font-heading font-bold text-base text-body mb-1 mt-4">Payment Information</h3>
              <p>
              ...
              <h3 className="font-heading font-bold text-base text-body mb-1 mt-4">Usage Data</h3>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">4. Information Sharing</h2>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">5. Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">6. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">7. Your Rights</h2>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">8. Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">9. Children&apos;s Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">10. Changes to This Policy</h2>
              <p>
            ...
            <section>
              <h2 className="font-heading font-bold text-lg text-body mb-2">11. Contact Us</h2>
              <p>
